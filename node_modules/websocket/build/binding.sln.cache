<Project DefaultTargets="Build" ToolsVersion="2.0" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    <SolutionDir>D:\Data Science %28AI%29\AI Human Interface\imagerecognitionrepo\image-recognition\node_modules\websocket\build\</SolutionDir>
    <SolutionExt>.sln</SolutionExt>
    <SolutionFileName>binding.sln</SolutionFileName>
    <SolutionName>binding</SolutionName>
    <SolutionPath>D:\Data Science %28AI%29\AI Human Interface\imagerecognitionrepo\image-recognition\node_modules\websocket\build\binding.sln</SolutionPath>
  </PropertyGroup>
  <PropertyGroup>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{8290117C-502F-0DBC-F4EE-8A89A96A2AFE}">Debug|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{88ECB199-39C8-BB0B-D37A-7ECA73358349}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{8290117C-502F-0DBC-F4EE-8A89A96A2AFE}">Release|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{88ECB199-39C8-BB0B-D37A-7ECA73358349}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="D:\Data Science %28AI%29\AI Human Interface\imagerecognitionrepo\image-recognition\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="D:\Data Science %28AI%29\AI Human Interface\imagerecognitionrepo\image-recognition\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="D:\Data Science %28AI%29\AI Human Interface\imagerecognitionrepo\image-recognition\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="D:\Data Science %28AI%29\AI Human Interface\imagerecognitionrepo\image-recognition\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
